...
const {TextChannel, MessageManager, Permissions} = require("discord.js");
...
class ThreadChannel extends TextChannel {
  ...
  constructor(guild, data, client, fromInteraction = false) {
     ...
     */
     Object.defineProperty(this, "messages", {
       get() { return new MessageManager(this) }
     });
    
    // A method to get the raw data of the ThreadChannel
    this._getData = () => {
      var res = Object.assign({}, data);
      res.guild = this.guild;
      return res;
    };
    ...
    Object.defineProperty(this, "members", {
      get() { return new ThreadMemberManager(this) }
    })
    
    if (data) this._patch(data, fromInteraction);
    this._applyThreadBasedChannel();
  }
  
  _applyThreadBasedChannel() {
    if ("threads" in this) delete this.threads;
  }
  ...
  archive(reason) {
    if (this.archived) return undefined;
    this.setArchived(true, reason);
    this.archived = true;
    return this;
  }
  ...
  // These are here only for documentation purposes - they are implemented by TextChannel
